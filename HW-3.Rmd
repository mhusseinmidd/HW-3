...
The results of our regression model show that age is a statistically significant predictor of sex. A one year increase in age, on average, is associated with a 1.021 increase in the odds of being female. This age logged odds estimate (0.0212) lies witin a 95% confidence interval that streches from 0.0142	to 0.0281. Conversely, having only some college education, compared to having a Bachelor's, is associated with a decrease in the odds of being female by 0.802 and its logged odds ratio falls within a confidence interval of [-0.396,	-0.0438]. 
